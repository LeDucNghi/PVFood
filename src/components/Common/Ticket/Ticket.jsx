    ...
    <div className="ticket" ref={ref}>
      ...
      <div className="ticket-inner">
        ...
        <div className="ticket-admit">
          <span className="char">{ticketName} </span>
        </div>
        <div className="ticket-numbers">{ticketTime} </div>
        <div className="ticket-numbers second">{ticketPercent}% </div>
      </div>
    </div>
  );
});
...
// Ticket.propTypes = {
//   ticketName: PropTypes.object.isRequired,
//   ticketTime: PropTypes.object.isRequired,
//   ticketDescribe: PropTypes.object,
//   ticketPercent: PropTypes.object.isRequired,
// };
